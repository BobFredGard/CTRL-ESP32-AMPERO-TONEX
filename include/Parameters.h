static short i, j, k, l, m, tmp, choiced_foot_on_pacer, tmp2 = 0;
static short data_base_choice, old_bank, menus, stomp = 0; 
static short id, id_init, idcopy, global_count, startscreen, bank, ampero_count, tonex_count = 1;
static short initial_state, boutton_choice, encoder1_copy_source, encoder2_copy_destination = 1;
static byte canal_midi_2 = 7; static byte canal_midi_1 = 8;
static byte preid = -1;
static byte ampero_bank_choice, tonex_bank_choice = 0;
static byte tx1, tx2, tx3 = 1;
static short tmpstomp1, tmpstomp2 = 1299;
static byte serveron = 0;

unsigned long previousMillis = 0;
unsigned short interval = 3000;
float view_tonex_value, all_data_base_parameters;

static short all_parameters [43][ 60];
static short all_data_base_parameters_copy [43] [60];
static short temp_transfert_datas [60];
...
static byte global_control_change [54] =  {
